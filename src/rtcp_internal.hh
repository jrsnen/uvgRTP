...
namespace uvgrtp {
    ...
    public:
        ...
        rtcp_internal(std::shared_ptr<uvgrtp::rtp> rtp, std::shared_ptr<std::atomic<std::uint32_t>> ssrc, std::shared_ptr<std::atomic<uint32_t>> remote_ssrc,
    ...
    private:
        ...
        static void rtcp_runner(rtcp_internal* rtcp);
